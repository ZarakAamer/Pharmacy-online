...
cart_product_list = CartOrderProductViewSet.as_view(
    {"get": "list", "post": "create"}
)
cart_product_detail = CartOrderProductViewSet.as_view(
    {"get": "retrieve", "put": "update", "delete": "destroy"}
)


order_list = OrderViewSet.as_view({"get": "list", "post": "create"})
order_product_list = OrderProductViewSet.as_view(
    {"get": "list", "post": "create"}
)
order_product_detail = OrderProductViewSet.as_view(
    {"get": "retrieve", "put": "update", "delete": "destroy"}
)


wishlist_list = WishlistViewSet.as_view({"get": "list", "post": "create"})
wishlist_product_detail = WishlistViewSet.as_view(
    {"get": "retrieve", "put": "update", "delete": "destroy"}
)
...
bankinfo = BankViewSet.as_view({"get": "list"})
