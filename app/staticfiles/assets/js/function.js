    ...
    $.ajax({
      ...
      success: function (response) {
        if (response.msg === "added") {
          ...
          alert("Login First");
        } else if (response.msg === "no stock") {
          alert("Out of Stock");
        } else if (response.msg === "Updated") {
          $(".cart-items-count").text(response.count);
          
        } else if (response.msg === "low quantity") {
          alert("selected quantity is not avalible");

          // alert(this_val)
          // document.getElementById("#add-to-cart-btn" + product_id).style.backgroundColor("white");
        } else {
          alert(response.msg);
        }
      },
      ...
      success: function (response) {
        if (response.bool === false) {
          ...
          if (response.bool === true) {
            var wishlist_count = document.getElementById("wishlist_counter");
            wishlist_count.innerHTML = response.count;
...
// // Add to cart functionality
// $(".add-to-cart-btn{{p.id}}").on("click", function(){
